...
namespace simplicity
{
	 ...
	 * {@link simplicity::opengl::SimpleOpenGLRenderingEngine SimpleOpenGLRenderingEngine} being tested does not have a
	 ...
	 * with the special condition that the {@link simplicity::opengl::SimpleOpenGLRenderingEngine} being tested uses a
	 * {@link simplicity::NamedRenderer}.
	 * </p>
	 */
