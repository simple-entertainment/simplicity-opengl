...
namespace simplicity
{
	namespace opengl
	{
		...
		string StencilClearingOpenGLRendererDemo::getDescription() const
		{
		...
		shared_ptr<Engine> StencilClearingOpenGLRendererDemo::getEngine() const
		{
			return renderingEngine;
		}

		string StencilClearingOpenGLRendererDemo::getTitle() const
		{
